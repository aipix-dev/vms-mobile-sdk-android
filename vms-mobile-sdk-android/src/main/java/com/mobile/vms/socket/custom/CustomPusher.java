...
public class CustomPusher implements Client {

    private final PusherOptions pusherOptions;
    private final InternalConnection connection;
    private final CustomChannelManager channelManager;
     ...
     * <li>Use the {@link #CustomPusher(String, PusherOptions)} constructor to create
     ...
     */
    public CustomPusher(final String apiKey) {
     ...
     */
    public CustomPusher(final String apiKey, final PusherOptions pusherOptions) {

        this(apiKey, pusherOptions, new CustomFactory());
    }
     ...
     */
    CustomPusher(final String apiKey, final PusherOptions pusherOptions, final CustomFactory factory) {
     ...
     * instance of {@linkplain CustomPusher}.
     *
     ...
     *
     * <p>Calls are ignored (a connection is not attempted) if the {@link Connection#getState()} is not {@link ConnectionState#DISCONNECTED}.</p>
     */
    public void connect() {
        connect(null);
    }
     ...
     *
     * <p>
     * Calls are ignored if the {@link Connection#getState()}, retrieved from {@link CustomPusher#getConnection}, is not
     * {@link ConnectionState#CONNECTED}.
     * </p>
     */
    public void disconnect() {
        // disconnect even if state CONNECTING
    ...
    /**
     * Subscribes to a {@link PrivateChannel} which
     * requires authentication.
     *
     * @param channelName The name of the channel to subscribe to.
     * @return A new {@link PrivateChannel}
     * representing the subscription.
     * @throws IllegalStateException if a {@link Authorizer} has not been set
     *                               for the {@link CustomPusher} instance via
     *                               {@link #CustomPusher(String, PusherOptions)}.
     */
     ...
     * @param eventNames  An optional list of names of events to be bound to on the channel. The equivalent of calling {@link Channel#bind(String, SubscriptionEventListener)} one or more times.
     * @return A new {@link PrivateChannel} representing the subscription.
     * @throws IllegalStateException if a {@link Authorizer} has not been set for the {@link CustomPusher} instance via {@link #CustomPusher(String, PusherOptions)}.
     */
    public PrivateChannel subscribePrivate(final String channelName, final PrivateChannelEventListener listener,
        ...
        final CustomPrivateChannelImpl channel = factory.newPrivateChannel(connection, channelName,
    ...
    /**
     * Subscribes to a {@link PresenceChannel} which
     * requires authentication.
     *
     * @param channelName The name of the channel to subscribe to.
     * @return A new {@link PresenceChannel}
     * representing the subscription.
     * @throws IllegalStateException if a {@link Authorizer} has not been set
     *                               for the {@link CustomPusher} instance via
     *                               {@link #CustomPusher(String, PusherOptions)}.
     ...
     * @param eventNames  An optional list of names of events to be bound to on the channel. The equivalent of calling {@link Channel#bind(String, SubscriptionEventListener)} one or more times.
     * @return A new {@link PresenceChannel} representing the subscription.
     * @throws IllegalStateException if a {@link Authorizer} has not been set for the {@link CustomPusher} instance via {@link #CustomPusher(String, PusherOptions)}.
     */
    public PresenceChannel subscribePresence(final String channelName, final PresenceChannelEventListener listener,
        ...
        final CustomPresenceChannelImpl channel = factory.newPresenceChannel(connection, channelName,
                pusherOptions.getAuthorizer());
        channelManager.subscribeTo(channel, listener, eventNames);
