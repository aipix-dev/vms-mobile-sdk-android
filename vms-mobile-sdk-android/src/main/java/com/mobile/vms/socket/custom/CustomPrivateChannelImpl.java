...
class CustomPrivateChannelImpl extends CustomChannelImpl implements PrivateChannel {
    ...
    public CustomPrivateChannelImpl(final InternalConnection connection, final String channelName,
