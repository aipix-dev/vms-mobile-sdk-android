...
public abstract class CustomWebSocketClient extends AbstractWebSocket implements Runnable, WebSocket {
     ...
     * @since 1.3.8
     */
    public CustomWebSocketClient(URI serverUri, Draft protocolDraft, Map<String, String> httpHeaders) {
     ...
     */
    public CustomWebSocketClient(URI serverUri, Draft protocolDraft, Map<String, String> httpHeaders, int connectTimeout) {
        if (serverUri == null) {
    ...
    public final void onWebsocketMessage(WebSocket conn, String message) {
        engine.updateLastPong();    //here was a bug
        onMessage(message);
    }
    ...
    private class WebsocketWriteThread implements Runnable {
        ...
        WebsocketWriteThread(CustomWebSocketClient webSocketClient) {
